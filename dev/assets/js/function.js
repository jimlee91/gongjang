(function ($, window, undefined) {
  $(function () {
    ...
    $('.cup__datebox .cup__dateitem').on('click', function(){
        $('.cup__datebox .cup__dateitem').removeClass('active');
        $(this).addClass('active');
    })
    $('.startcards-box .statcards').niceScroll({
      cursorcolor: '#fff',
      cursorwidth: '5px',
      autohidemode: false
    });
    $('.cup__datebox .inner').niceScroll({
        cursorcolor: '#fff',
        cursorwidth: '5px',
        autohidemode: false
    });
    ...
    $('.search-history__tab button').on('click', function (e) {
      ...
      $('.search-history__view' + tabNumber)
        .stop()
        .fadeIn();
    });
